...
public :
	...
	void createSnow()
	{
		...
		psq3->retain();										//保持引用
		psq3->setTexture( Director::getInstance()->getTextureCache()->addImage("snow.png") );	//为粒子系统设置图片
...
public :
	ParticleSystemQuad* psq1 = ParticleSystemQuad::create("dragEffect.plist");//在地面滑行的时候    方块后面的特效
	bool isPsq1 = false;
	ParticleSystemQuad* psq2 = ParticleSystemQuad::create("explodeEffect.plist");//撞击后，  方块爆炸的特效
